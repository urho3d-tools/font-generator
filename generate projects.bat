...
:: Создаём проекты для Visual Studio 2022 в папке build_vs17, используя конфиг CMakeLists.txt из папки src
cmake src -B build_vs17 -G "Visual Studio 17" -A Win32^
